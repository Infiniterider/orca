...
(function(dice) {
    ...
    this.dice_box = function(container, dimentions) {
        ...
        this.renderer.setClearColor(0x00ff00, 0.4);
...
//use this to determine when to stop dice clattering noises
        var res = true;
        var e = 6;
    ...
    this.dice_box.prototype.start_throw = function(notation_getter, before_roll, after_roll) {
        ...
        prepare_rnd(function() {
            ...
            //var vector = { x: (1) * box.w, y:-(rnd() * 2 - 1) * box.h };
...
//this.getDiceValues = get_dice_values(this.dices);
